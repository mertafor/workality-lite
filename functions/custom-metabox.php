...
if ( ! function_exists( 'works_images_fields' ) ) {
	function works_images_fields() { 
		$args = array(	
						array(
							'type'=>'info-array',
							'desc'=>__('<span style="font-size:11px;line-height:14px;">Mixed media content. Add images, videos through embed code (Youtube, Vimeo etc.) and re-order items by drag&drop. Make sure click on Update to save changes.</span>','dronetv')
						),array(
							'type'=>'imagearr',
							'title'=>'',
							'name'=> 'work-media',
